...
class Centrum {
     ...
     */
    createSubscription(name, id, handler) { throw new Error('Server is not configured to use subscriptions.'); }
    /**
     ...
     */
    createOrAddSubscription(name, id, handler) { throw new Error('Server is not configured to use subscriptions.'); }
    /**
    ...
    _createSubscription(name, id, handler) {
    ...
    _createOrAddSubscription(name, id, handler) {
