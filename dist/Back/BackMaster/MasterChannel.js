...
class BackMasterChannel extends Channel_1.Channel {
    ...
    initialize(masterURI, frontMasterURIs) {
        this.messenger = new dist_1.Messenger('b' + this.backMasterIndex);
    ...
    addChannels(channelIds) {
        ...
        channelIds.forEach(channelId => {
            const backChannel = new BackChannel_1.BackChannel(channelId, this.messenger, this);
     ...
     */
    handleQueuedMessages(messageQueueData) {
