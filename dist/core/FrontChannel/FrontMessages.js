...
class FrontMessages extends MessageFactory_1.MessageFactory {
    ...
    initializeSubs() {
        ...
        this.SET_STATE = this.subCreator(MessageFactory_1.Protocol.SET_STATE(this.frontUid), this.frontUid);
        this.PATCH_STATE = this.subCreator(MessageFactory_1.Protocol.PATCH_STATE(this.frontUid), this.frontUid, 'NONE');
