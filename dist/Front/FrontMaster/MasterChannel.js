...
const dist_1 = require("gotti-pubsub/dist");
...
class FrontMasterChannel extends Channel_1.Channel {
    ...
    initialize(masterURI, backMasterURIs) {
        this.messenger = new dist_1.Messenger(this.frontMasterIndex);
    ...
    addChannels(channelIds) {
        if (this.messenger === null)
            throw 'initialize messenger before adding channels';
        channelIds.forEach(channelId => {
            const frontChannel = new FrontChannel_1.FrontChannel(channelId, channelIds.length, this.messenger, this);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                for (let i = 0; i < this.frontChannelIds.length; i++) {
                    const connected = yield this.frontChannels[this.frontChannelIds[i]].connect();
